    ...
    methods: {
        ...
        showPageInfo(){
            this.$swal({
                ...
                html: '<div>This map communicates the recorded locations for accused witches places of death in Scotland taken from the Scottish Survey of Witchcraft Database. These deaths are the result of <b class="font-bold">execution under the charge of witchcraft</b>. Although there were <b class="font-bold">3212</b> accused witches, there are recorded places of death for only <b class="font-bold">111</b> of these accused witches. Many of these locations are recorded in the exact spot of the accused witches\' execution. There are another <b class="font-bold">119</b> accused witches that were executed recorded within the Scottish Survey of Witchcraft Database without a geographical location. Many of the accused witches were executed by being strangled (hung) and then burned. It is thought that a large volume of executions were not formally recorded.</div>',
