<template>
  <div id="main-content" class="text-wrapper">
    ...
    <p class="mb-3"><a href="https://docs.google.com/document/d/14JcTa6twIjsx69ifoZxVf-VaXR7nFmmQhu52zXUYUD4/edit?usp=sharing" target="_blank">Items added to Wikidata word document</a></p>
    <p class="mb-3"><a href="https://w.wiki/6rX" target="_blank">Query for accused witches residence map</a></p>
  </div>
</template>
