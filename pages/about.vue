<template>
  <div id="main-content" class="text-wrapper" style="width: 100%">
    ...
    <p class="mb-3">
      ...
      <a
        href="https://witches.hca.ed.ac.uk/home/"
    ...
    <div class="paragraph-container">
      <div class="text" style="width: calc(65% - 20px)">
        <p class="mb-3">
          ...
          an interactive map as linked open data through Wikipedia's sister
          project, Wikidata
        </p>
      </div>
    ...
    <div class="paragraph-container">
      <div class="text" style="width: calc(60% - 20px)">
        ...
        <p class="mb-3">
          ...
          investigation, the trial, and its aftermath. She focused especially on
          all the different accusations: who named/denounced who, what occurred
          in the supposed witches’ meetings, the ritual objects used,
          accusations of shapechanging and much more. By working round the clock
    ...
    <div class="paragraph-container">
      <div class="text">
        <ul class="mb-3">
          ...
          <li>
            Allow filtering on multiple filter options at a time and move the
            filters to the left hand side of the screen to allow more space for
            the map.
          </li>
          <li>
            Add a new customizable and more responsive timeline of witchcraft
            investigations which can be filtered to search for ‘witchcraft
