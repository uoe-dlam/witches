<template>
    <div id="main-content" class="pl-5 pr-5 pt-3 pb-3">
        ...
        <p class="mb-3">This is a first attempt to geolocate this data. We have consulted a number of historical sources to locate places that have variant spellings in the records or that have since disappeared. We appreciate all feedback and will incorporate it into future iterations of the map. You can read more about how we went about geo locating some of this information <b><a href="https://blogs.ed.ac.uk/ecarroll3_witchcraft_visualisation" target="_blank">here</a></b>.</p>
        <p class="mb-3"><b class="font-bold">Background to the project</b></p> 
        <p class="mb-3">The Data and Visualisation internship project at the University of Edinburgh had as its core aim to geographically locate and visualise the different locations recorded within the Survey of Scottish Witchcraft Database - <b><a href="http://www.shca.ed.ac.uk/witches/" target="_blank">http://www.shca.ed.ac.uk/witches</a></b>.</p>
        <p class="mb-3">You can read an excellent summary of the project to date on Anne-Marie Scott's blog here: <b><a href="https://ammienoot.com/brain-fluff/some-witchy-history-and-a-very-smart-woman-in-data-science/" target="_blank">Some witchy history and a very smart woman in data science</a></b></p>
        <p class="mb-3"><b class="font-bold">Teaching data science with ‘real-world’ datasets</b></p>
        ...
        <p class="mb-3"><b class="font-bold">The ‘Witchfinder General’ internship (June to September 2019)</b></p> 
