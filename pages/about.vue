<template>
  <div id="main-content" class="text-wrapper" style="width:100%">
    ...
    <p class="mb-3">This Data and Visualisation internship project at the University of Edinburgh started with the aim of geographically locating and visualising the different locations recorded within the Survey of Scottish Witchcraft Database - <a class="underline hover:text-gray-500" href="http://www.shca.ed.ac.uk/witches/" target="_blank">http://www.shca.ed.ac.uk/witches</a>. Since the project stared more data and visualisations have been added to the site.</p>
