...
export default {
    data: () => ({
        ...
        attribution: 'Map data © <a href="https://www.openstreetmap.org/copyright">OpenStreetMap contributors</a>. Historical Maps Layer, 1750 Dorret Map from the <a href="http://maps.nls.uk/projects/api/">NLS Maps API</a>',
        zoom: 7,
        center: [55.95, -3.198888888],
        clusterOptions: {
            iconCreateFunction: function (cluster) {
                let html = '<div><img src="/images/witches-cluster-composite-yellow.png" width="72" height="54"></div>';
