    ...
    <div id="main-nav">
        <nav class="flex items-center justify-between flex-wrap bg-white p-5 w-full">
          <div class="flex items-center mr-3">
              <h1 class="text-xl sm:text-4xl mr-4">Witches</h1><img src="/images/witches-cluster-composite.png" alt="logo" width="100" >
          ...
          <div :class="open ? 'block': 'hidden'" class="w-full block flex-grow xl:flex xl:items-center xl:w-auto">
