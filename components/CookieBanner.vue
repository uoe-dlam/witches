<template>
  <div
    class="w-full flex flex-col z-40 py-2 bg-slate-400 pr-3 absolute bottom-0"
    v-if="!hideBanner"
  >
    <p class="text-xs md:text-sm ml-2 mt-1">
      We use cookies to analyse site traffic to understand our users' behaviour
      and how the site is doing, and to store your cookie preferences. This
      includes Google Analytics anonymised data. If you wish to turn off Google
      Analytics you can do so by clicking reject non essential cookies.
    </p>
