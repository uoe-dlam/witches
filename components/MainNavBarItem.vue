<template>
  <span class="dropdown block lg:inline-block">
    ...
    <NuxtLink :to="url" class="block xl:pt-1 xl:pb-1 mt-4 lg:inline-block lg:mt-0 text-gray-500 hover:text-black lg:mr-2 xl:mr-4" :class="{ 'menuBarItemActive' :  isSubpageActive(subpages)}" v-else>
      <slot></slot>
    </NuxtLink>
