...
export default {
    getJulianDate: function (date, precision) {
        ...
        if (precision === PRECISION_MONTH_YEAR) {
            ...
            return `${(currentGregorianDate.getMonth() + 1).toString().padStart(2, "0")}/` + `${currentGregorianDate.getFullYear()}`;
        }
        ...
        return `${julianDate.getDate().toString().padStart(2, "0")}/` +  `${(julianDate.getMonth() + 1).toString().padStart(2, "0")}/` + `${julianDate.getFullYear()}`;
    }
