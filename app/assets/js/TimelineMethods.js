const TimelineMethods = {
    ...
    checkEndMarkers: function (
        ...
        if (dateFrequencyUnit === 'years') {
            ...
            lastPeriodLength = this.getRangeLengthDays([
                lastMarkerDateObj,
                lastDate,
            ])
        }
    ...
    getTimelineData: function (dateRange) {
        ...
        if (rangeLengthYears > 50) {
            let [dateFrequency, markerFrequencyModulo] =
                this.getDatesFrequencies(20, rangeLengthYears)
        ...
        if (rangeLengthYears > 15) {
            let [dateFrequency, markerFrequencyModulo] =
                this.getDatesFrequencies(24, rangeLengthYears)
            return this.getTimelineLongRangeData(
                dateRange,
                rangeLengthYears,
                dateFrequency,
        ...
        if (rangeLengthYears > 1) {
            let [dateFrequency, markerFrequencyModulo] =
                this.getDatesFrequencies(24, rangeLengthMonths)
